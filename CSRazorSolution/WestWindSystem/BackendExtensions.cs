...
namespace WestWindSystem
{
    public static class BackendExtensions
    {
        ...
        {
            // within this method, we will register all the services that will be used by the system (context setup) and will be provided by the system
            ...
            // add any business logic layer class to the service collection so our web app has access to the methods (services) within the BLL class.
