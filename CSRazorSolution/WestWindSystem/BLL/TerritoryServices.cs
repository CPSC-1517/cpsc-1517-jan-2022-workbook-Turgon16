...
namespace WestWindSystem.BLL
{
    public class TerritoryServices
    {
        ...
        #region Queries
        //query by a string
        //this partial search query has been altered to allow for paging of its results.
                                                        ...
                                                        out int totalcount)
        {
            ...
            //using the paging parameters to obtain only the necessary records (rows) that will be shown by the Paginator.
